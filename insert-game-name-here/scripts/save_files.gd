...
func reset_save_text()->void:
	$saveButton.text = "Save File "+ str(1+6*pageNum)
	$saveButton2.text = "Save File "+ str(2+6*pageNum)
	$saveButton3.text = "Save File "+ str(3+6*pageNum)
	$saveButton4.text = "Save File "+ str(4+6*pageNum)
	$saveButton5.text = "Save File "+ str(5+6*pageNum)
	$saveButton6.text = "Save File "+ str(6+6*pageNum)
